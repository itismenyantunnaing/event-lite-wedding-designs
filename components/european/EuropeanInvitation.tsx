  ...
  return (
    <main className="european-theme">
      <section className="hero section">
        ...
        <h1><span>{couple.partnerOne}</span><i>&amp;</i><span>{couple.partnerTwo}</span></h1>
        <p className="invitation">{europeanDemo.invitation}</p>
        <div className="date" aria-label={date.label}>
          <span>{date.day}</span><span className="date-rule">{date.weekday}</span><span>{date.month}</span><span>{date.year}</span>
        </div>
      ...
      <section className="section venue">
        ...
        <a className="button" href={venue.mapUrl} target="_blank" rel="noreferrer">Open map</a>
      </section>
      ...
      <section className="section timeline">
        ...
        <div className="schedule-route">
          <svg className="schedule-path" viewBox="0 0 390 720" aria-hidden="true">
            ...
            <text x="196" y="27">♥</text><text x="196" y="708">♥</text>
          </svg>
          <ol>
            {schedule.map((item) => (
      ...
      <section className="section details">
        ...
        <div className="detail-copy gifts-copy">
          <p className="section-kicker">A little note</p><h2>Your presence is our present</h2><p>{europeanDemo.giftNote}</p>
        </div>
        <div className="detail-copy dress-copy">
          <p className="section-kicker">Dress code</p><h2>Garden formal</h2><p>{europeanDemo.dressCode}</p>
      ...
      <section className="section rsvp">
        <p className="section-kicker">Kindly reply by August 1</p><h2>Will you join us?</h2><RSVPForm />
      </section>
